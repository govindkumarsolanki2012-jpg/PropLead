...
export const SplashScreen: React.FC<SplashScreenProps> = ({ className = '' }) => {
  return (
    <div
      ...
      className={`flex-1 w-full flex flex-col justify-between items-center bg-white dark:bg-slate-900 text-slate-900 dark:text-white px-6 select-none transition-colors duration-200 ${className}`}
      style={{
    ...
    >
      {/* Top spacer for status bar clearance */}
      ...
      <div className="flex flex-col items-center justify-center text-center -mt-6">
        ...
        {/* App Name */}
        <h1 className="text-3xl font-black tracking-tight text-slate-900 dark:text-white mt-4 leading-none">
